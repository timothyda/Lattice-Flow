  ...
  return new Promise((resolve, reject) => {
    ...
    const server = createServer((req, res) => {
      try {
        ...
        res.end(code
          ? '<html><body style="font-family:sans-serif;text-align:center;padding:60px"><h2 style="color:#0073ea">&#10003; Connected!</h2><p>You can close this tab and return to Opus Flo.</p></body></html>'
